...
//}
  ...
  ideas.forEach(title => {
    ...
    templateJson[0].content = `Write a short blog post about ${title}.`;
    writeFileSync( `${title.slice(0,5).trim()}${Math.floor(Math.random()*10)}.chat.json`, JSON.stringify(templateJson));
  });
